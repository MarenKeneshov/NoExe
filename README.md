...
**NoExe** — простое и мощное приложение для блокировки запуска нежелательных процессов через IFEO.
...
1. Добавьте имя процесса, который хотите заблокировать (вместе с расширением .exe) 
...
- Ограничение запуска нежелательных программ  
...
1. Add the name of the process you want to block (including the `.exe` extension)  
2. Enable blocking  
